...
public enum Role {
    CUSTOMER (Set.of(CHANGE_PASSWORD, CHANGE_CREDENTIALS, CHECK_OFFERS, CHECK_CALENDAR, CHECK_AGENTS,
                ...
                FILL_CREDITWORTHINESS_INFO, CHECK_CREDITWORTHINESS, CHECK_DETAILS)),
    OWNER(Set.of(CHANGE_PASSWORD, CHANGE_CREDENTIALS, REPORT_OFFER, CHECK_CALENDAR, CHECK_AGENTS, ADD_DOCUMENTS,
                UPLOAD_PHOTO, SCHEDULE_MEETING, CHECK_MEETINGS, CHECK_ARCHIVED_OFFERS, REVIEW_AGENT, CHECK_DETAILS,
                CHECK_DOCUMENTS)),
    ADMIN(Set.of(CHANGE_PASSWORD, CHANGE_CREDENTIALS, ADD_AGENT, REMOVE_USER, ADD_ADMIN, CHECK_AGENTS, CHECK_DETAILS)),
